...
{
  new (message_memory) interface::msg::Zero(_init);
}

void Zero_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::msg::Zero *>(message_memory);
  typed_message->~Zero();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Zero_message_member_array[1] = {
  {
    ...
    offsetof(interface::msg::Zero, structure_needs_at_least_one_member),  // bytes offset in struct
...
get_message_type_support_handle<interface::msg::Zero>()
{
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Zero_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, Zero)() {
  return &::interface::msg::rosidl_typesupport_introspection_cpp::Zero_message_type_support_handle;
}
